        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Order Placed! 🎉', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: AppColors.dark)),
              const SizedBox(height: 12),
              const Text('Your order has been placed successfully.\nYou can track it in the Orders tab.', textAlign: TextAlign.center, style: TextStyle(fontSize: 15, color: AppColors.textMid, height: 1.5)),
